...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "report_status", "report_status", new[] { "pending", "accepted", "assigned", "on_the_way", "collected", "failed", "reported_by_team" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "team_type", "team_type", new[] { "main", "support" });
            ...
            modelBuilder.Entity("WasteCollectionPlatform.DataAccess.Entities.WasteReportItem", b =>
                {
                    ...
                    b.HasKey("ItemId")
                        .HasName("wastereportitem_pkey");

                    b.HasIndex("ReportId");

                    b.ToTable("WasteReportItems", (string)null);
                });
